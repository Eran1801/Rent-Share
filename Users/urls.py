...
from Users.forget_password import views_forget_pass
...
urlpatterns = [
    ...
    re_path(r'^forget_password/$', views_forget_pass.forget_password, name='forget_password'),
    re_path(r'verify_password_reset_code/$', views_forget_pass.verify_code, name='verify_password_reset_code'),
    re_path(r'^reset_password/$', views_forget_pass.reset_password, name='reset_password'),
